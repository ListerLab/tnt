...
```{r, cache=TRUE}
type_32F <- readRDS("~/Downloads/drive-download-20230512T033020Z-001/32F_celltype.rds")
type_32F
```


```{r, cache=TRUE}
treat_32F <- readRDS("~/Downloads/drive-download-20230512T033020Z-001/32F_treatment.rds")

cowplot::plot_grid(type_32F, type_32F, nrow = 1, ncol = 2)
