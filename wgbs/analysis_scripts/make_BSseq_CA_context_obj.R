...
make_bsseq_obj <- function(CGmap_path, context="CA"){
        
        gc()
        
        id <- basename(CGmap_path) %>% stringr::str_replace(pattern = ".CGmap.gz", replacement = "")
...
make_bsseq_obj(CGmap_path=path, context="CA")
