...
Calculate mCG in GeneHancer regulatory elements. Table `resources/hg19_USCS_geneHancerClusteredInteractionsDoubleElite.txt` downloaded from UCSC table browser.
```{r, cache=TRUE}
...
**Figure 1d**
Plot PCA of regulatory element mCG
```{r, cache=TRUE}
